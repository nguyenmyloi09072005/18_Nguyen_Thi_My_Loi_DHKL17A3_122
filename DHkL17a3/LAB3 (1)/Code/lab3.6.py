...
DataFrame_stock1 = pd.read_csv('D:\Python nâng cao\DHkL17a3\LAB3 (1)\DATA\stocks1.csv')
DataFrame_stock2 = pd.read_csv('D:\Python nâng cao\DHkL17a3\LAB3 (1)\DATA\stocks2.csv')
